                ...
                <font color=#300b59>
                    ...
                    <div id="login"><section>
                        ...
                        <div style="text-align: left; width: 320px">
                            ...
                            <br>
                                <center>
                                    <p style="font-size: 15px">Não possui login? &nbsp; <a class="cadastro" href="form_cadastro1.php" style="font-size: 15px">Faça seu cadastro!</a></p>
                                    <a class="cadastro" href="form_email.php" style="font-size: 15px">Esqueceu sua senha?</a><br><br>
                                </center>
                            </div>
                        </center>
                    </section></div>
