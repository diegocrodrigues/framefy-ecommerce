                ...
                <?php
                    ...
                    if(isset($_SESSION['usuario']))
                    {
                        ...
                        if($_GET['compra']==1)
                        {
                            ...
                            $SQL="SELECT * FROM compra,produto WHERE id_cliente=$id_cliente AND compra.excluido='n' AND produto.id_produto=compra.id_produto ORDER BY id_compra;";
                            $RESULTADO=pg_query($conecta,$SQL);
                            $Linhas=pg_num_rows($RESULTADO);
                            $aux=0;
                            $total=0;
