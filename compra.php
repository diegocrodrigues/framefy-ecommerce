    ...
    <body>
        ...
        <center>
            ...
            <br><br><br><br><br><br><br>
                <?php
                    ...
                    for($i=1;$i<=$maior;$i++)
                    {
                        if(isset($_SESSION['carrinho'][$i]))
                        {
                            ...
                            $sql="INSERT INTO compra VALUES ($auxiliar,$id_cliente,$i,$quantidade,$preco,$total,'n',NULL);";
                            $resultado=pg_query($conecta,$sql);
                            $Linhas=pg_affected_rows($resultado);
                        }
                    }
                    if($flag)
                    {
                        ...
                        // Seu nome 
                         ...
                         // Corpo do email 
                         $mail->msgHTML("<html>de: Framefy<br/>email: framefy.equipeE@gmail.com<br/>Compra realizada com sucesso</html>");
               ...
               <h1>Obrigade por comprar no Framefy!</h1><br>
                <form action="tuto2.php" method="post">
                    <input type="submit" value="Ver comprovante" style="font-size: 15px; background-color: transparent; border: 2px solid #8b78ad; padding: 6px; color: #300b59">
            </form>
                <br><br>
               <a class="cadastro" href="index.php">Voltar</a>
